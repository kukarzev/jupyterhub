...
jupyterhubdir = r'/software/jupyterhub'
...
c.JupyterHub.cookie_secret_file = os.path.join(jupyterhubdir, 'jupyterhub_cookie_secret')

# The location of jupyterhub data files (e.g. /usr/local/share/jupyter/hub)
# c.JupyterHub.data_files_path = '/software/jupyterhub/venv/share/jupyter/hub'
...
c.JupyterHub.db_url = 'sqlite:///{}'.format(os.path.join(jupyterhubdir, 'jupyterhub.sqlite'))
...
c.JupyterHub.extra_log_file = os.path.join(jupyterhubdir, 'jupyterhub.log')
...
c.JupyterHub.hub_port = c.JupyterHub.port + 1

# The ip for the proxy API handlers
# c.JupyterHub.proxy_api_ip = '127.0.0.1'

# The port for the proxy API handlers
c.JupyterHub.proxy_api_port = c.JupyterHub.port + 2
...
# 
# Use with ssl_key
#c.JupyterHub.ssl_cert = os.path.join(jupyterhubdir, 'ssl', 'sample-server.crt')
c.JupyterHub.ssl_cert = os.path.join(jupyterhubdir, 'ssl', 'lshost02.crt')

# Path to SSL key file for the public facing interface of the proxy
# 
# Use with ssl_cert
#c.JupyterHub.ssl_key = os.path.join(jupyterhubdir, 'ssl', 'sample-server.key')
c.JupyterHub.ssl_key = os.path.join(jupyterhubdir, 'ssl', 'lshost02.key')
...
c.SudoSpawner.sudospawner_path = os.path.join(jupyterhubdir, 'venv', 'bin', 'sudospawner')
